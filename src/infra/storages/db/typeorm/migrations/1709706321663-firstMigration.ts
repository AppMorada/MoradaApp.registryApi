...
export class FirstMigration1709706321663 implements MigrationInterface {
	name = 'Migrations1709706321663';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			'CREATE TABLE "enterprise_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cpf" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "condominium_id" uuid NOT NULL, CONSTRAINT "UQ_5aded7c2cf19ef8d251ee987b0f" UNIQUE ("cpf", "condominium_id"), CONSTRAINT "UQ_87e0d48e0b88dd71fb048319df3" UNIQUE ("user_id", "condominium_id"), CONSTRAINT "REL_045ab85f2e1e678d08ad910f02" UNIQUE ("user_id"), CONSTRAINT "PK_c1144a402891d4cd092913b6d51" PRIMARY KEY ("id"))',
		);
		await queryRunner.query(
			'CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "email" character varying(320) NOT NULL, "phone_number" bigint, "password" character(60) NOT NULL, "tfa" smallint NOT NULL DEFAULT \'0\', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))',
		);
		await queryRunner.query(
			'CREATE TABLE "condominium_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cpf" bigint NOT NULL, "c_email" character varying(320) NOT NULL, "apartment_number" integer, "block" character varying(6), "auto_edit" smallint NOT NULL DEFAULT \'0\', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "condominium_id" uuid NOT NULL, "user_id" uuid, CONSTRAINT "UQ_15559912745339103b3470e147c" UNIQUE ("cpf", "condominium_id"), CONSTRAINT "UQ_284ea20d719d10e9ab23a529b31" UNIQUE ("c_email", "condominium_id"), CONSTRAINT "UQ_7fa95bbaabfb700de542aaaa691" UNIQUE ("user_id", "condominium_id"), CONSTRAINT "PK_6ff037a5659872d22b490adb2c9" PRIMARY KEY ("id"))',
		);
		await queryRunner.query(
			'CREATE TABLE "invites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "recipient" character varying(320) NOT NULL, "code" character varying(60) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "condominium_id" uuid NOT NULL, "member_id" uuid NOT NULL, CONSTRAINT "UQ_e2e42f29fb4a509a7e5a5d9db8e" UNIQUE ("recipient", "condominium_id"), CONSTRAINT "UQ_aaed78f6a737fe6318b8f151600" UNIQUE ("member_id", "condominium_id"), CONSTRAINT "REL_dce11b81d78d14cb6ce9f57370" UNIQUE ("member_id"), CONSTRAINT "PK_aa52e96b44a714372f4dd31a0af" PRIMARY KEY ("id"))',
		);
		await queryRunner.query(
