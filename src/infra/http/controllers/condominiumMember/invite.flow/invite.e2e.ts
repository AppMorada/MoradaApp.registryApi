...
describe('Gen and Reload invite E2E test', () => {
	let sut: INestApplication;
	const endpoint = (id: string) => `/condominium/${id}/invite`;
	const endpointToReloadInvite = () => '/condominium/invite/reload';
	...
	it('should be invite a condominium member', async () => {
