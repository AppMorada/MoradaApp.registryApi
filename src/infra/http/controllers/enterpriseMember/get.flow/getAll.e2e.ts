...
describe('Get all enterprise member E2E test', () => {
	...
	const endpoint = (id: string) => `/condominium/${id}/enterprise-user/all`;
	...
	it('should get a condominium member list', async () => {
		...
		expect(typeof res1.body?.employees?.[0]?.id).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.name).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.email).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.CPF).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.phoneNumber).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.createdAt).toEqual('string');
		expect(typeof res1.body?.employees?.[0]?.updatedAt).toEqual('string');
	});
