...
describe('CPF Value Object test', () => {
	...
	it('should be able to throw one error: length error', () => {
		expect(() => new CPF('1112223339')).toThrowError(EntitieError);
	});

	it('should be able to throw one error: length error', () => {
		expect(() => new CPF('111222333966')).toThrowError(EntitieError);
	});

	it('should be able to throw one error: length error', () => {
		expect(() => new CPF('11122233395')).toThrowError(EntitieError);
	});
});
